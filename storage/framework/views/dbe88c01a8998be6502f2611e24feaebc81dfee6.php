...
<div class="login-box">
  <div class="login-logo" style="margin-left: -12px;margin-top: -50px">
    <img src="<?php echo e(url('public/adminlte/dist/img/mgi_gideon_adi.png')); ?>" width="410" height="100">
    <p style="font-size: 25px">Registered Public Accountants And Business Advisors</p>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border-radius: 20px; margin-top:-10px">
   ...
   <?php if(\Session::has('alert')): ?>
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(url('/api/loginPost/')); ?>">
...
<?php /**PATH E:\xampp\htdocs\timesheet\resources\views//layouts/login.blade.php ENDPATH**/ ?>