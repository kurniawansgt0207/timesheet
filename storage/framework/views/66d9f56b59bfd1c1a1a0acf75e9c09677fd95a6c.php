...
<div class="col-md-6">
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">Per Category Year to Date <?php echo e($label); ?></h3>
...
<script>
    ...
    function getGraph_3()
    {
        ...
        $('#graph_3').load('<?php echo e(url("/")); ?>/dashboard/graph_3/'+status3);
    }

</script><?php /**PATH C:\xampp\htdocs\sdhc\resources\views/layouts/graph_dashboard/graph_3.blade.php ENDPATH**/ ?>